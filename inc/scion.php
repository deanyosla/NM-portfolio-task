<div class="main-content">
        ...
        <h1 class="scs_h1">Introduction to The Scion Coalition Scheme</h1>
        <div id="scs" class="scs container">
          <div class="tab-1">
            <h2>Introduction to SCS</h2>
            <p>
...
<br><br> The platform's structured curriculum and hands-on approach empower users to learn at their own pace, with access to interactive quizzes and coding challenges.
          ...
          <img class="logo" src="images/icons/netmatters.png" alt="Netmatters logo">
            ...
            <span
              >Digital Marketing, Website & Software development & IT
              Support</span
            >
